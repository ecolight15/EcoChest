...
public final class m
{
  ...
  public static String get(String format)
  {
    ...
    String msgbuf = (String)msgMap.get(format);
    if (msgbuf == null) {
      return "MessageLoadErr";
    }
  ...
  public static boolean msgLoad(String loc, EcoChest plugin)
  {
    if (msgMap == null) {
      msgMap = new HashMap();
    }
    ...
    msgMap.put("cmd_param_invalid", "コマンドパラメーターの指定が不正です");
  ...
  public static String cnvCOLOR2STR(ChatColor color)
  {
    ...
    case DARK_GREEN: 
      result = "DARK_GREEN"; break;
    case DARK_AQUA: 
      result = "DARK_AQUA"; break;
    case DARK_RED: 
      result = "DARK_RED"; break;
    case DARK_PURPLE: 
      result = "DARK_PURPLE"; break;
    case GOLD: 
      result = "GOLD"; break;
    case GRAY: 
      result = "GRAY"; break;
    case DARK_GRAY: 
      result = "DARK_GRAY"; break;
    case BLUE: 
      result = "BLUE"; break;
    case GREEN: 
      result = "GREEN"; break;
